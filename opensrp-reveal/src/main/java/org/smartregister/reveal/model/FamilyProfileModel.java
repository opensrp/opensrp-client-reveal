...
public class FamilyProfileModel extends BaseFamilyProfileModel {
    ...
    private void tagEventClientDetails(FamilyEventClient eventClient) {
        ...
        eventClient.getEvent().setLocationId(org.smartregister.tasking.util.Utils.getOperationalAreaLocation(PreferencesUtil.getInstance().getCurrentOperationalArea()).getId());
    }
