...
public class EventRegisterInteractor implements EventRegisterContract.Interactor {
    ...
    public EventRegisterInteractor(EventRegisterContract.Presenter presenter) {
