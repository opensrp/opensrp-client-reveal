...
public class ChildProfilePresenterTest extends BaseUnitTest {
    ...
    @Test
    public void testUpdateChild() throws JSONException {
        ...
        Mockito.verify(processor).tagLocationData(processor.getCurrentOperationalArea());
    ...
    @Test
    public void testSaveADRForm() throws JSONException {
