...
public class UtilsTest {
    ...
    public void testCreateGeoJSONCircle() throws Exception {
        ...
        FeatureCollection expectedFeatureCollection = FeatureCollection.fromJson(geoJSONCircleJSonString);
        assertNotNull(expectedFeatureCollection);
        LatLng center = new LatLng(15.0913957, 101.18959799999999);
        FeatureCollection actualFeatureCollection = createGeoJSONCircle(center, DEFAULT_INDEX_CASE_CIRCLE_RADIUS_IN_METRES, DEFAULT_GEO_JSON_CIRCLE_SIDES );

        assertNotNull(actualFeatureCollection);
        assertEquals(expectedFeatureCollection.type(), actualFeatureCollection.type());
        assertNotNull(actualFeatureCollection.features());
        assertNotNull(actualFeatureCollection.features().get(0));
        assertEquals(expectedFeatureCollection.features().get(0).type(), actualFeatureCollection.features().get(0).type());
        assertNotNull(actualFeatureCollection.features().get(0).geometry());
        assertEquals(expectedFeatureCollection.features().get(0).geometry().type(), actualFeatureCollection.features().get(0).geometry().type());
