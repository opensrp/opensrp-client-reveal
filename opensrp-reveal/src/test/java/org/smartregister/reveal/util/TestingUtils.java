...
public class TestingUtils {
    ...
    public static String structureJSON = "{\"id\": \"170230\", \"type\": \"Feature\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [32.59610261651737, -14.171511296715634]}, \"properties\": {\"status\": \"Active\", \"version\": 0, \"parentId\": \"3429\", \"geographicLevel\": 4}, \"serverVersion\": 1542970626353}";
    ...
    public static StructureTaskDetails getStructureTaskDetails() {
        ...
        taskDetails.setBusinessStatus(BusinessStatus.NOT_VISITED);
        taskDetails.setTaskEntity(UUID.randomUUID().toString());
